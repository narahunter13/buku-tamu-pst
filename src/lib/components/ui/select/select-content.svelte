...
<SelectPortal {...portalProps}>
	...
	>
		...
		<SelectPrimitive.Viewport
			class={cn(
				'h-(--bits-select-anchor-height) w-full min-w-(--bits-select-anchor-width) scroll-my-1 scrollbar-thin overflow-y-auto'
			)}
		>
			{@render children?.()}
		</SelectPrimitive.Viewport>
